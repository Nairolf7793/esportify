...
<div id="carouselExampleRide" class="carousel slide w-50 " data-bs-ride="true">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="../.gitignore/image/manette.jpg" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="../.gitignore/image/enfant.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item">
      <img src="../.gitignore/image/console.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
...
<div class="d-grid gap-2 col-6 mx-auto m-4">
    <div class="d-flex justify-content-center">
        <p>Detail de l'evenement 1</p>
        <p>Heures, minutes, secondes</p>
        <button class="btn btn-primary" type="button">Evenement 1</button>
    </div>
    <div class="d-flex justify-content-center">
        <p>Detail de l'evenement 2</p>
        <p>Heures, minutes, secondes</p>
        <button class="btn btn-primary" type="button">Evenement 2</button>
    </div>
    <div class="d-flex justify-content-center">
        <p>Detail de l'evenement 3</p>
        <p>Heures, minutes, secondes</p>
        <button class="btn btn-primary" type="button">Evenement 3</button>
    </div>
</div>